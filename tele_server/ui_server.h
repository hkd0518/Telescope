...
**
** Created: Sun May 1 23:00:57 2011
...
public:
    ...
    void setupUi(QDialog *Server)
    {
        ...
        Server->resize(289, 360);
        showText = new QTextEdit(Server);
...
""));
    ...
    {
        Server->setWindowTitle(QApplication::translate("Server", "Chat", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
